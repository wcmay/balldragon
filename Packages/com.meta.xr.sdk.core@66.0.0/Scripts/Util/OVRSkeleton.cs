        ...
        if (_enablePhysicsCapsules)
        {
            ...
            for (int i = 0; i < _capsules.Count; ++i)
            {
                ...
                if (capsule.CapsuleRigidbody == null)
                {
                    ...
                    capsule.CapsuleRigidbody.isKinematic = false;
                    capsule.CapsuleRigidbody.useGravity = false;
                    capsule.CapsuleRigidbody.collisionDetectionMode = CollisionDetectionMode.Continuous;
                    capsule.CapsuleRigidbody.gameObject.layer = 8;
                    capsule.CapsuleRigidbody.constraints = RigidbodyConstraints.FreezeRotation;
                    capsule.CapsuleRigidbody.mass = 9000;
                }
                ...
                if (capsule.CapsuleCollider == null)
                {
                    ...
                    capsule.CapsuleCollider.gameObject.layer = 8;
                }
                ...
                capsule.CapsuleCollider.radius = _skeleton.BoneCapsules[i].Radius * 0.9f;
